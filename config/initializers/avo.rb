Avo.configure do |config|
  ...
  ## == Authentication ==
  config.current_user_method = ->(request) { User.find_by(id: request.session[:user_id], active: true) }
  # config.resource_parent_controller = "::ApplicationController"

  config.authenticate_with do
    unless _current_user&.admin? || _current_user&.manager?
